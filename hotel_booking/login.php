...
<body>
	...
	<div class="btn-group btn-group-lg " style="padding:50px;padding-left:100px; ">
			<a href="signup.php"  class="btn btn-danger1" style="background-color:#585858">Signup&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="login.php" class="btn btn-danger1 " style="background-color:#FF69B4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login</a>
 
		</div>
      <form method="post" action="login_check.php">
	    
      <div>
		<label  style="padding-left:150px;">Welcome Back*</label>
	</div>
		<div class="tm-form1">
   ...
   <div class="btn-group btn-group-justified" style="padding:0px;padding-left:30px;">
			
			<a href="login_check.php" class="btn btn-danger1" style="background-color:#FF69B4" > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LOGIN &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
